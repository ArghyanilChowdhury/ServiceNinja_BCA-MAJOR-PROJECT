...
<?php
$ous="select User_Email from userdetails where User_Username='$username'";
$our=mysqli_query($con,$ous);
$oupr=mysqli_fetch_assoc($our);
?>
<head>
    <meta charset="utf-8">
    <title>Orders - ServiceNinja.com</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Your Orders</h1>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 col-lg-6">
                    <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                        ...
                        <h1 class="mb-0">Your Current Orders and Order History</h1>
                    </div>
            ...
            <table id="customers">
                <tr>
                    ...
                    <th>Requester Full Address</th>
                    <th>Requester Preferred Day and Time</th>
                    <th>Message by Requester</th>
                    <th>Technician Assigned</th>
                </tr>
                <?php
                $ouem = $oupr['User_Email'];
                $select = "select order_id, order_SCN, order_SEN, order_SEP, order_stat, order_UST, order_UADR, order_SDAY, order_STIME, order_MSSG, asgn_tech from order_req where order_UEM = '$ouem'";
