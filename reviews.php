...
<head>
    ...
    <title>Reviews - Admin Portal - Service Ninja.com</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Testimonials / Reviews</h4>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <?php
                                            $select="select review_id, user_name, user_username, user_rating, user_review, datetime from review_table";
                                            ...
                                            while($row=mysqli_fetch_assoc($res))
                                            {
                                                ...
                                                <td><span><a href="delete_reviews.php?q=<?php echo $row['review_id'];?>" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-close color-red"></i></a></span></td>
                                                <!--
