...
<head>
    ...
    <title>Admin Details - Admin Portal - Service Ninja.com</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table header-border">
                                        ...
                                        <tbody>
                                        <?php
                                            $select="select AdminID,AdminPhoto,AdminFirstName,AdminMiddleName,AdminLastName,AdminEmail,AdminPhno from admindetails";
                                            ...
                                            while($row=mysqli_fetch_assoc($res))
                                            {
                                                ...
                                                <tr>
                                                <td><?php echo $c;?></td>
                                                <td> <img src="admin_img/<?php echo $row['AdminPhoto']; ?>" width="200" title="<?php echo $row['AdminPhoto']; ?>"> </td>
