...
<body onload="printAndRedirect();">
    ...
    <h2>
        <center>Bill Invoice<center>
    </h2>
    <center>
        <table border="1">
            <?php
            $order_id = $_SESSION['order_id'];
            $pdfsel = "SELECT order_id, order_UFN, order_ULN, order_SCN, order_SEN, order_SEP, order_UST, order_UADR, order_UEM, order_UPHNO, order_SDAY, order_STIME FROM order_req WHERE order_id='$order_id'";
