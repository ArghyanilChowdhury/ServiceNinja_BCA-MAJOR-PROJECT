...
<head>
    <meta charset="utf-8">
    <title>Services - ServiceNinja.com</title>
    ...
    <section class="section-products">
        <div class="container">
            ...
            <div class="row">
                <!-- Single Product -->
                <?php
                    $select="select ServiceImage,ServiceName from addservicedetails";
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div id="" class="single-product">
                                ...
                                <img src="../ADMIN SECTION/theme_1/service_img/<?php echo $row['ServiceImage']; ?>" width="300px" height="200px">
                            
                            
                            <h3><center><br><?php echo $row['ServiceName'];?></center></h3>
