...
<head>
    <meta charset="utf-8">
    <title>User Dashboard - ServiceNinja.com</title>
    ...
    <section class="section-products">
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8 col-lg-6">
                    <div class="section-title text-center position-relative pb-3 mb-5 mx-auto"
                        ...
                        <h1 class="mb-0">Choose Your Required Service</h1>
                    </div>
            ...
            <div class="row">
                <!-- Single Product -->
                <?php
                    $select="select ServiceID,ServiceImage,ServiceName from addservicedetails";
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div id="" class="single-product">
                                ...
                                <a href="service_form.php?q=<?php echo $row['ServiceID'];?>"><img src="../ADMIN SECTION/theme_1/service_img/<?php echo $row['ServiceImage']; ?>" width="300px" height="200px"></a>
                            
                            
                            <h3><center><a href="service_form.php?q=<?php echo $row['ServiceID'];?>"><br><?php echo $row['ServiceName'];?></center></h3></a>
