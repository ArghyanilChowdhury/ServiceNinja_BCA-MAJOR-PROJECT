...
<head>
    <meta charset="utf-8">
    <title>Home Page - ServiceNinja.com</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">
    <link rel="icon" type="image/x-icon" href="img/OSMSLOGO.webp">
...
<body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Customer's Happiness is Our Aim.
                            </h1>
                            <a href="userlogin.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Book
                                A Service Now</a>
                            <!-- <a href="" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">SignIn</a>-->
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown"></h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Innovative Service
                                Solutions</h1>
    ...
    <div class="container-fluid facts py-5 pt-lg-0">
        <div class="container py-5 pt-lg-0">
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            ...
                            ?>
                            <h1 class="text-white mb-0" data-toggle="counter-up"><?php echo $rouc['user_count']; ?></h1>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-primary mb-0">Services Done</h5>
                            <?php
                            ...
                            ?>
                            <h1 class="mb-0" data-toggle="counter-up"><?php echo $rocsc['comp_count']; ?></h1>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white mb-0">Total Reviews</h5>
                            <?php
            ...
            FROM review_table";
                            ...
                            ?>
                            <h1 class="text-white mb-0" data-toggle="counter-up"><?php echo $rortrc['review_count']; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">The Best Solutions By Best Service Professionals</h1>
                    </div>
                    <p class="mb-4">Service Ninja is a tech platform that connects customers with home services. From beauty treatments to repairing, our hand-picked service partners deliver quality services at the customer’s convenience. Our vision: Empower professionals worldwide to redefine home services.</p>
                    <div class="row g-0 mb-3">
                        ...
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>24/7 Support For Repairing
                                Services</h5>
    ...
    <!-- Product repairing service start-->
                ...
                ?>
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div id="" class="single-product">
                            ...
                            <h3>
                                <center><br><?php echo $row['ServiceName']; ?></center>
                            </h3>
    ...
    <!-- Product repairing service end-->

    <!-- Product health service start-->
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">We Are Here to Make Your Life Easier</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <p class="mb-0">Industry-leading expertise and unparalleled service excellence set us apart as the best choice.</p>
                        </div>
                        <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                            ...
                            <p class="mb-0">Our commitment to delivering top-notch services ensures unparalleled quality and customer satisfaction.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                            ...
                            <p class="mb-0">Our team of seasoned professionals brings expertise and dedication to every service interaction.</p>
                        </div>
                        <div class="col-12 wow zoomIn" data-wow-delay="0.8s">
                            ...
                            <h4>24/7 Support</h4>
                            <p class="mb-0">Experience peace of mind with our round-the-clock support, ready to assist you anytime, anywhere.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Quote Start -->
    <!--
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" id="free_service">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h5 class="fw-bold text-primary text-uppercase">Request a free service</h5>
                        <h1 class="mb-0">Want to book a free service? Please feel free to Contact Us.</h1>
                    </div>
                    <div class="row gx-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Call to ask any question</h5>
                            <h4 class="text-primary mb-0">+91 343 358 2256</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn"
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Request A Free
                                        Service</button>
                                </div>
                            </div>
                        </form>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.6s">
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        ...
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Rakesh Kumar Pati</h4>
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        ...
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Saikat Pain</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        ...
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Partha Gorai</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
                ...
                <div class="testimonial-item bg-light my-4">
                    <div class="d-flex align-items-center border-bottom pt-5 pb-4 px-5">
                        ...
                        <div class="ps-4">
                            <h4 class="text-primary mb-1">Karina Mahanta</h4>
                            <small class="text-uppercase">Profession</small>
                        </div>
                    </div>
                    <div class="pt-4 pb-5 px-5">
...
-->
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Company Founders</h5>
                <h1 class="mb-0">Founders Who Gave Birth To This Company.</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Subhankar Karmakar</h4>
                            <p class="text-uppercase m-0"></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Moumita Patra </h4>
                            <p class="text-uppercase m-0"></p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold text-primary text-uppercase">Our Partnership Brands</h5>
        </div>
