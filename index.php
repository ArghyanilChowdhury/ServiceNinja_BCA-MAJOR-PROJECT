...
<head>
    ...
    <title>Admin Portal - ServiceNinja.com</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">Service Orders Completed</h3>
                                <div class="d-inline-block">
                                    ...
                                    ?>
                                    <h2 class="text-white"><?php echo $rocsc['comp_count']; ?></h2>

                                    <p class="text-white mb-0">Apr - May 2024</p>
                                </div>
        ...
        ";
                                    ...
                                    ?>
                                    <h2 class="text-white"><?php echo "Rs. " . $net_profit; ?></h2>
                                    <p class="text-white mb-0">Apr - May 2024</p>
                                </div>
                        ...
                        <div class="card gradient-3">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    ...
                                    ?>
                                    <h2 class="text-white"><?php echo $rouc['user_count']; ?></h2>
                                    <p class="text-white mb-0">Apr - May 2024</p>
                                </div>
                        ...
                        <div class="card gradient-4">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <?php
                                    $sql = "
                                    SELECT SUM(user_rating) AS total_ratings, COUNT(*) AS total_reviews 
                                    FROM review_table
                                ";
                                    ...
                                    if ($result) {
                                        ...
                                        if ($total_reviews > 0) {
                                            // Calculate the maximum possible rating sum
                                            $max_possible_ratings = $total_reviews * 5;

                                            // Calculate satisfaction rate as a percentage
                                            $satisfaction_rate = ($total_ratings / $max_possible_ratings) * 100;
                                        }
                                    }
                                    ?>
                                    <h2 class="text-white"><?php echo number_format($satisfaction_rate, 2) . "%"; ?></h2>
                                    <p class="text-white mb-0">Apr - May 2024</p>
                                </div>
        ...
        ";
                                            ...
                                            ?>
                                            <h3 class="m-0"><?php echo "Rs. " . $net_profit; ?></h3>
                                        </div>
                                        <div>
                                            <ul>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="w-100 mr-2">
                                                <h6>Beauty Care Services</h6>
                                                <div class="progress" style="height: 6px">
                                                    <div class="progress-bar bg-danger" style="width: 40%"></div>
                                                </div>
                                            </div>
                                            <div class="ml-2 w-100">
                                                <h6>Repairing Services</h6>
                                                <div class="progress" style="height: 6px">
