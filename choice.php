...
<head>
    <meta charset="utf-8">
    <title>Login / Signup - ServiceNinja.com</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Login / Signup</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <a href="userlogin.php">
                        ...
                        <img class="img-fluid w-100" src="img/userlogin.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <a href="userregistration.php">
                        <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/usersignup.jpg" alt="">
                        </div>
                        <div class="text-center py-4">
