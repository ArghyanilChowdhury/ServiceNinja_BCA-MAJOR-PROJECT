...
<head>
    <meta charset="utf-8">
    <title>Anti Discrimination Policy - ServiceNinja.com</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Anti Discrimination Policy</h1>
        ...
        <div class="container py-12">
            <div class="row g-12">
                <div class="col-lg-12">
                    ...
                    <h5 class="mb-4" style="font-size: 25px;">Service Ninja seeks to empower millions of service professionals across the world to deliver safe, reliable and high quality services at home. Service Ninja therefore does not tolerate, and prohibits discrimination against customers or service providers based on religion, caste, race, national origin, disability, sexual orientation, sex, marital status, gender identity, age or any other characteristic that may protected under applicable laws.
                    <br>
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    Any customer or service partner found to have violated this prohibition will lose access to the Service Ninja Company platform.
