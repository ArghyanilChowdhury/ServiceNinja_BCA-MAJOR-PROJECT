...
$catno=$_GET['q'];
$selectcat="select * from admindetails where AdminID='$catno'";
...
<head>
    ...
    <title>Edit Admin Details- Admin Portal - Service Ninja.com</title>
    <!-- Favicon icon -->
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post" autocomplete="off" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-firstname" name="val-firstname" placeholder="Enter First Name" value="<?php echo $row['AdminFirstName'];?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-mname" name="val-mname" placeholder="Enter Middle Name" value="<?php echo $row['AdminMiddleName'];?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-lname" name="val-lname" placeholder="Enter Last Name" value="<?php echo $row['AdminLastName'];?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="email" class="form-control" id="val-email" name="val-email" placeholder="Enter E-Mail Address" value="<?php echo $row['AdminEmail'];?>" readonly required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="email" class="form-control" id="val-altemail" name="val-altemail" placeholder="Enter Alternate E-Mail Address" value="<?php echo $row['AdminAltEmail'];?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-phno" name="val-phno" placeholder="Enter Phone Number" value="<?php echo $row['AdminPhno'];?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-altphno" name="val-altphno" placeholder="Enter Alternate Phone Number" value="<?php echo $row['AdminAltPhno'];?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="password" class="form-control" id="val-accpass" name="val-accpass" placeholder="Enter Account Password" value="<?php echo $row['AdminAccPass'];?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
            ...
            if(isset($_POST['reg']))
            {
                if($_FILES["image"]["error"] === 4){
                ...
                else
                    {
                            ...
                            if($apa == $acpa)
                            {
                                $updatequery="UPDATE admindetails SET AdminPhoto='$newImageName', AdminFirstName='$afn',AdminMiddleName='$amn',AdminLastName='$aln',AdminPhno='$aph',AdminAltPhno='$aaltph',AdminAccPass='$apa' WHERE AdminID='$catno'";
                            ...
                            {
                                echo "<script>alert('Error: Password Mismatched! Please Try Again!!');</script>";
                            }
